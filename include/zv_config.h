...
#define ERROR_ACCESS_NOT_ALLOWED_MEM			10
...
#define VM_BIT_EXCEPT_BREAKPOINT				(0x01 << 3)
...
#define VM_EXIT_INT_TYPE_PRIV_SW					5
...
#define EXCEPTION_VECTOR_BOUND_RANGE_EXCEEDED		5
...
#define EXCEPTION_VECTOR_FLOATING_POINT_ERROR		16
